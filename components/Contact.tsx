...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 relative bg-[#0f1729] text-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-10 md:mb-16">
                <span className="text-jc-gold font-bold uppercase tracking-wider text-xs md:text-sm mb-2 block">Fale Conosco</span>
            ...
            <div className="flex flex-col lg:flex-row gap-8 md:gap-12 max-w-6xl mx-auto">
                ...
                {/* Contact Info */}
                <div className="w-full lg:w-1/3 space-y-4 md:space-y-8 order-2 lg:order-1">
                ...
                {/* Form */}
                <div className="w-full lg:w-2/3 bg-white/5 p-6 md:p-10 rounded-3xl border border-white/10 backdrop-blur-md shadow-2xl order-1 lg:order-2">
                    <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                            <div className="group">
                                ...
                                <input 
                                    ...
                                    name="name" 
                                    required
                                    className="w-full bg-gray-900/50 border border-gray-700 rounded-xl px-4 py-4 md:py-4 focus:outline-none focus:border-jc-gold text-white transition-all group-hover:border-gray-600 text-lg"
                        ...
                        <div className="group">
                            ...
                            <textarea 
                                ...
                                rows={4}
                                required
                                className="w-full bg-gray-900/50 border border-gray-700 rounded-xl px-4 py-4 md:py-4 focus:outline-none focus:border-jc-gold text-white transition-all group-hover:border-gray-600 resize-none text-lg"
                        ...
                        <button 
                            type="submit" 
                            className="w-full bg-gradient-to-r from-jc-gold to-jc-goldDark hover:from-white hover:to-white hover:text-jc-navy text-jc-navy font-black py-4 md:py-5 rounded-xl transition-all text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 active:scale-[0.98]"
                        >
